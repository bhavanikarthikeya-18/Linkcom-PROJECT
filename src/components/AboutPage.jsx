  ...
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8">
        ...
        <p className="text-gray-600 text-sm mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full">
          Linkcom simplifies URL shortening for efficient sharing. Easily
          generate, manage, and track your shortened links. Linkcom simplifies
          URL shortening for efficient sharing. Easily generate, manage, and
          track your shortened links. Linkcom simplifies URL shortening for
          efficient sharing. Easily generate, manage, and track your shortened
          links. Linkcom simplifies URL shortening for efficient sharing.
          Easily generate, manage, and track your shortened links.
        </p>
        <div className="space-y-5 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full">
          <div className="flex items-start">
            <FaLink className="text-emerald-500 text-3xl mr-4" />
            <div>
          ...
          <div className="flex items-start">
            <FaShareAlt className="text-teal-500 text-3xl mr-4" />
            <div>
              <h2 className="sm:text-2xl font-bold text-slate-800">
                Powerful Analytics
              </h2>
          ...
          <div className="flex items-start">
            <FaEdit className="text-cyan-500 text-3xl mr-4" />
            <div>
              <h2 className="sm:text-2xl font-bold text-slate-800">
                Enhanced Security
              </h2>
          ...
          <div className="flex items-start">
            <FaChartLine className="text-amber-500 text-3xl mr-4" />
            <div>
              <h2 className="sm:text-2xl font-bold text-slate-800">
                Fast and Reliable
              </h2>
