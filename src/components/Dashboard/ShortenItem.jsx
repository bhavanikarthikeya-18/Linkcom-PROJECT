...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const fetchMyShortUrl = async () => {
        setLoader(true);
        try {
             const { data } = await api.get(`/api/urls/analytics/${selectedUrl}?startDate=2024-01-01T00:00:00&endDate=2027-12-31T23:59:59`, {
                        headers: {
  ...
  return (
    <div className={`bg-white shadow-lg border border-dotted border-emerald-400 px-6 sm:py-1 py-3 rounded-md transition-all duration-100 `}>
    <div className={`flex sm:flex-row flex-col  sm:justify-between w-full sm:gap-0 gap-5 py-5 `}>
      <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden ">
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
            ...
            >
                <div className="flex cursor-pointer gap-1 items-center bg-btnColor py-2 font-semibold shadow-md shadow-emerald-300 px-6 rounded-md text-white ">
            ...
            <div
                ...
                className="flex cursor-pointer gap-1 items-center bg-teal-600 py-2 font-semibold shadow-md shadow-teal-300 px-6 rounded-md text-white "
            >
